...
SAPSTotalWHR$IHA[SAPSTotalWHR$GEOGID == "26701100"] <- "Three"
SAPSTotalWHR$IHA[SAPSTotalWHR$GEOGID == "Ireland"] <- "Ignore"
SAPSTotalWHR$CHN[SAPSTotalWHR$GEOGID == "26701100"] <- "Three"
...
SAPSTotal <- rbind(SAPSTotalIHA,SAPSTotalRegion,SAPSTotalCHN)#facto
