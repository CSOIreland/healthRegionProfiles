...
CSVForHTML$Report <- paste0("<a href=\"https://healthregionprofiles.cso.ie/2022/iha/pdf/",CSVForHTML$ReportNumber,"-",CSVForHTML$EDLC,"-",CSVForHTML$ACLC,".pdf","\"", " target=\"_blank\"", " title=\"",CSVForHTML$IHA," pdf report\"", ">","PDF","</a>", "  "  )
