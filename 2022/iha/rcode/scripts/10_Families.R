...
FamAll$Region <- factor(FamAll$Region, levels = c(ED,AC,"State"))
...
FamPlot2 <- highchart()|>       
  hc_add_series(FamAll, "column", hcaes(x = Type.of.Family, y = PercentageOfFamilies, color = colouract,  group = Region), color = c('#405381','#FCBE72','#13C1A5'), showInLegend = T)|>
  hc_yAxis(
