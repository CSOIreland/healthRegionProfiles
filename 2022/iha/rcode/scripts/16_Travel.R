...
TravelBinded$Region <- factor(TravelBinded$Region, levels = c(ED,AC,"State"))
...
TravelPlot2 <- highchart()|>       
  hc_add_series(TravelBinded, "column", hcaes(x =Means.of.Travel2, y = PercentageOfPopulation, color = colouract,  group = Region), color = c('#405381','#FCBE72','#13C1A5'), showInLegend = T)|>
  hc_yAxis(
