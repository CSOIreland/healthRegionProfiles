...
PopSourceTableWSA$IHA[PopSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
PopSourceTableWSA$IHA[PopSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
PopSourceTableRegion <- PopSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Sex,Age,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

PopSourceTableIHA <- PopSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Sex,Age,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
PopSourceTable <- rbind(PopSourceTableRegion,PopSourceTableIHA)
#factorise age
...
CarersSourceTableWSA$IHA[CarersSourceTableWSA$CSO.Small.Areas.2022 == "026701100"] <- "HSE Dublin South and Wicklow"
CarersSourceTableWSA$IHA[CarersSourceTableWSA$CSO.Small.Areas.2022 == "00Ireland"] <- "Ignore"

CarersSourceTableRegion <- CarersSourceTableWSA%>%select(-c(IHA,CSO.Small.Areas.2022))%>%group_by(Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

CarersSourceTableIHA <- CarersSourceTableWSA%>%select(-c(Region,CSO.Small.Areas.2022))%>%group_by(Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
CarersSourceTable <- rbind(CarersSourceTableRegion,CarersSourceTableIHA)
#factorise age
...
GenSourceTableWSA$IHA[GenSourceTableWSA$CSO.Small.Areas.2022 == "026701100"] <- "HSE Dublin South and Wicklow"
GenSourceTableWSA$IHA[GenSourceTableWSA$CSO.Small.Areas.2022 == "00Ireland"] <- "Ignore"
GenSourceTableRegion <- GenSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(General.Health,Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
GenSourceTableIHA <- GenSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(General.Health,Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
GenSourceTable <- rbind(GenSourceTableRegion,GenSourceTableIHA)
...
DisSourceTable2WSA$IHA[DisSourceTable2WSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"

DisSourceTable2WSA$IHA[DisSourceTable2WSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"


DisSourceTable2IHA <- DisSourceTable2WSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
DisSourceTable2Region <- DisSourceTable2WSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
DisSourceTable2<-rbind(DisSourceTable2Region,DisSourceTable2IHA)
...
SmokingSourceTableWSA$IHA[SmokingSourceTableWSA$CSO.Small.Areas.2022 == "026701100"] <- "HSE Dublin South and Wicklow"
SmokingSourceTableWSA$IHA[SmokingSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
SmokingSourceTableWSA$IHA[SmokingSourceTableWSA$CSO.Small.Areas.2022 == "00Ireland"] <- "Ignore"
SmokingSourceTableRegion <- SmokingSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Smoke.Tobacco.Products,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
SmokingSourceTableIHA <- SmokingSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Smoke.Tobacco.Products,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")

SmokingSourceTable <- rbind(SmokingSourceTableRegion,SmokingSourceTableIHA)
#factorise age
...
EduSourceTableWSA$IHA[EduSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
EduSourceTableWSA$IHA[EduSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
EduSourceTableRegion <- EduSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Highest.Level.of.Education.Completed,Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
EduSourceTableIHA <- EduSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Highest.Level.of.Education.Completed,Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
#bind both tables
EduSourceTable <- rbind(EduSourceTableRegion,EduSourceTableIHA)
...
PESSourceWSA$IHA[PESSourceWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
PESSourceWSA$IHA[PESSourceWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"

PESSourceRegion <- PESSourceWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Principle.Economic.Status,Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
PESSourceIHA <- PESSourceWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Principle.Economic.Status,Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
PESSource <- rbind(PESSourceRegion,PESSourceIHA)
...
FamSourceWSA$IHA[FamSourceWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
FamSourceWSA$IHA[FamSourceWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
FamSourceRegion <- FamSourceWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Type.of.Family,Age.of.Child,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
FamSourceIHA <- FamSourceWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Type.of.Family,Age.of.Child,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
FamSource <- rbind(FamSourceRegion,FamSourceIHA)
...
BirthSourceWSA$IHA[BirthSourceWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
BirthSourceWSA$IHA[BirthSourceWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
BirthSourceRegion <- BirthSourceWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Location,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

BirthSourceIHA <- BirthSourceWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Location,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")

BirthSource <- rbind(BirthSourceRegion,BirthSourceIHA)
...
VolunteersSourceTableWSA$IHA[VolunteersSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
VolunteersSourceTableWSA$IHA[VolunteersSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"

VolunteersSourceTableRegion <- VolunteersSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

VolunteersSourceTableIHA <- VolunteersSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
VolunteersSourceTable <- rbind(VolunteersSourceTableRegion,VolunteersSourceTableIHA)
...
SocialClassSourceTableWSA$IHA[SocialClassSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
SocialClassSourceTableWSA$IHA[SocialClassSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
SocialClassSourceTableRegion <- SocialClassSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Social.Class,Sex,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

SocialClassSourceTableIHA <- SocialClassSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Social.Class,Sex,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")

SocialClassSourceTable <- rbind(SocialClassSourceTableRegion,SocialClassSourceTableIHA)
...
HouseholdsSourceTableWSA$IHA[HouseholdsSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
HouseholdsSourceTableWSA$IHA[HouseholdsSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"

HouseholdsSourceTableRegion <- HouseholdsSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Type.of.Occupancy,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

HouseholdsSourceTableIHA <- HouseholdsSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Type.of.Occupancy,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")

HouseholdsSourceTable <- rbind(HouseholdsSourceTableRegion,HouseholdsSourceTableIHA)
...
RenewableEnergySourceTableWSA$IHA[RenewableEnergySourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
RenewableEnergySourceTableWSA$IHA[RenewableEnergySourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
RenewableEnergySourceTableRegion <- RenewableEnergySourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Renewable.Energy,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

RenewableEnergySourceTableIHA <- RenewableEnergySourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Renewable.Energy,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
RenewableEnergySourceTable <- rbind(RenewableEnergySourceTableRegion,RenewableEnergySourceTableIHA)
######################################TRAVEL#########################################
#REad ED and AC  table from PXSTat
...
TravelSourceTableWSA$IHA[TravelSourceTableWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
TravelSourceTableWSA$IHA[TravelSourceTableWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"
TravelSourceTableRegion <- TravelSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Means.of.Travel,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))

TravelSourceTableIHA <- TravelSourceTableWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Means.of.Travel,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")

TravelSourceTable <- rbind(TravelSourceTableIHA,TravelSourceTableRegion)
...
FamiliesInPrivateHouseholdsWSA$IHA[FamiliesInPrivateHouseholdsWSA$CSO.Small.Areas.2022 == "26701100"] <- "HSE Dublin South and Wicklow"
FamiliesInPrivateHouseholdsWSA$IHA[FamiliesInPrivateHouseholdsWSA$CSO.Small.Areas.2022 == "Ireland"] <- "Ignore"

FamiliesInPrivateHouseholdsRegion <- FamiliesInPrivateHouseholdsWSA%>%select(-c(CSO.Small.Areas.2022,IHA))%>%group_by(Household.Size,Census.Year,Statistic,Region)%>%dplyr::summarise(value = sum(value))
FamiliesInPrivateHouseholdsIHA<- FamiliesInPrivateHouseholdsWSA%>%select(-c(CSO.Small.Areas.2022,Region))%>%group_by(Household.Size,Census.Year,Statistic,IHA)%>%dplyr::summarise(value = sum(value))%>%dplyr::rename("Region" = "IHA")
FamiliesInPrivateHouseholds <- rbind(FamiliesInPrivateHouseholdsRegion,FamiliesInPrivateHouseholdsIHA)